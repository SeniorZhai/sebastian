...
import static sebastian.work.impl.utils.PackageManagerHelper.setComponentEnabled;
...
import sebastian.work.impl.background.systemalarm.SystemAlarmScheduler;
import sebastian.work.impl.background.systemalarm.SystemAlarmService;
import sebastian.work.impl.background.systemjob.SystemJobScheduler;
import sebastian.work.impl.background.systemjob.SystemJobService;
 ...
 *
 * Helps schedule {@link sebastian.work.impl.model.WorkSpec}s while enforcing
...
public class Schedulers {
    ...
    private static final String FIREBASE_JOB_SCHEDULER_CLASSNAME =
            "sebastian.work.impl.background.firebase.FirebaseJobScheduler";

    @VisibleForTesting
    static final String FIREBASE_JOB_SERVICE_CLASSNAME =
            "sebastian.work.impl.background.firebase.FirebaseJobService";
