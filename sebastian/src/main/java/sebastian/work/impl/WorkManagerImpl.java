...
import sebastian.work.Configuration;
import sebastian.work.ExistingPeriodicWorkPolicy;
import sebastian.work.ExistingWorkPolicy;
import sebastian.work.OneTimeWorkRequest;
import sebastian.work.PeriodicWorkRequest;
import sebastian.work.R;
import sebastian.work.SynchronousWorkManager;
import sebastian.work.WorkContinuation;
import sebastian.work.WorkManager;
import sebastian.work.WorkRequest;
import sebastian.work.WorkStatus;
import sebastian.work.impl.background.greedy.GreedyScheduler;
import sebastian.work.impl.model.WorkSpec;
import sebastian.work.impl.model.WorkSpecDao;
import sebastian.work.impl.utils.CancelWorkRunnable;
import sebastian.work.impl.utils.ForceStopRunnable;
import sebastian.work.impl.utils.LiveDataUtils;
import sebastian.work.impl.utils.Preferences;
import sebastian.work.impl.utils.PruneWorkRunnable;
import sebastian.work.impl.utils.StartWorkRunnable;
import sebastian.work.impl.utils.StopWorkRunnable;
import sebastian.work.impl.utils.taskexecutor.TaskExecutor;
import sebastian.work.impl.utils.taskexecutor.WorkManagerTaskExecutor;
...
public class WorkManagerImpl extends WorkManager implements SynchronousWorkManager {
    ...
    public WorkManagerImpl(
        ...
        mWorkDatabase = WorkDatabase.create(context, useTestDatabase); // 创建Work数据库
        mTaskExecutor = WorkManagerTaskExecutor.getInstance(); // Executor
        ...
        mPreferences = new Preferences(mContext); // preferences
