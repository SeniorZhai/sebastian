...
import sebastian.work.impl.model.SystemIdInfo;
import sebastian.work.impl.model.SystemIdInfoDao;
import sebastian.work.impl.model.WorkName;
import sebastian.work.impl.model.WorkNameDao;
...
import sebastian.work.impl.model.WorkTagDao;
import sebastian.work.impl.model.WorkTypeConverters;
import java.util.concurrent.TimeUnit;

import static sebastian.work.impl.model.WorkTypeConverters.StateIds.COMPLETED_STATES;
import static sebastian.work.impl.model.WorkTypeConverters.StateIds.ENQUEUED;
import static sebastian.work.impl.model.WorkTypeConverters.StateIds.RUNNING;
...
public abstract class WorkDatabase extends RoomDatabase {
    ...
    private static Callback generateCleanupCallback() {
        return new Callback() {
            @Override
    ...
    private static long getPruneDate() {
